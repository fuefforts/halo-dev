...
import { s as sakura, U as Util } from "../main.min.js";
import { N as NProgress } from "../assets/nprogress-f7f36964.js";
var pjax$1 = { exports: {} };
...
if (Pjax.isSupported()) {
  ...
  pjax$1.exports = stupidPjax;
}
var pjaxExports = pjax$1.exports;
const Pjax$1 = /* @__PURE__ */ getDefaultExportFromCjs(pjaxExports);
NProgress.configure({ trickle: false });
const pjax = new Pjax$1({
  elements: "a[data-pjax]",
  selectors: ["head title", ".wrapper", ".pjax"],
  switches: {
    ".wrapper": Pjax$1.switches.innerHTML
  },
  analytics: false,
  cacheBust: false,
  debug: true
});
pjax.doRequest = function(location2, options, callback) {
  options = options || {};
  var queryString;
  var requestOptions = options.requestOptions || {};
  var requestMethod = (requestOptions.requestMethod || "GET").toUpperCase();
  ...
  if (options.cacheBust) {
    location2 = updateQueryString(location2, "t", Date.now());
  }
  request.open(requestMethod, location2, true);
  request.timeout = timeout;
  request.setRequestHeader("X-Requested-With", "XMLHttpRequest");
...
window.addEventListener("pjax:success", () => {
  let pjaxDoms = document.querySelectorAll("script[data-pjax]");
  pjaxDoms.forEach((element) => {
    ...
    if (element.dataset.pjax !== void 0) {
      script.dataset.pjax = "";
    }
    if (code !== "") {
      script.appendChild(document.createTextNode(code));
