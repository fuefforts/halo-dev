...
var ZRender = function() {
  function ZRender2(id, dom, opts) {
    ...
    var handlerProxy = !env$1.node && !env$1.worker && !ssrMode ? new HandlerProxy(painter.getViewportRoot(), painter.root) : null;
...
export {
  ...
  distance as V,
  add as W,
  subPixelOptimizeLine as X,
  quadraticSubdivide as Y,
  ZRText$1 as Z,
  __extends as _,
  ZRImage$1 as a,
  TSpan$1 as a$,
  normalize as a0,
  cubicDerivativeAt as a1,
  cubicAt as a2,
  quadraticDerivativeAt as a3,
  quadraticAt as a4,
  Point$1 as a5,
  Displayable$1 as a6,
  retrieve2 as a7,
  ...
  distSquare as aR,
  clone as aS,
  containStroke$4 as aT,
  containStroke$2 as aU,
  mergeAll as aV,
  normalizeRadian as aW,
  lift as aX,
  rotate as aY,
  isMiddleOrRightButtonOnMouseUpDown as aZ,
  stop as a_,
  subPixelOptimizeRect as aa,
  subPixelOptimize as ab,
  Transformable$1 as ac,
  invert as ad,
  hasOwn as ae,
  trim as af,
  normalizeCssArray as ag,
  isTypedArray as ah,
  setAsPrimitive as ai,
  concatArray as aj,
  noop as ak,
  calculateTextPosition as al,
  LRU$1 as am,
  platformApi as an,
  Eventful$1 as ao,
  ...
  parsePercent as at,
  eqNaN as au,
  registerPainter as av,
  windingLine as aw,
  getBoundingRect as ax,
  dist$1 as ay,
  lerp$1 as az,
  bind as b,
  copy as b0,
  ...
  stringify as b2,
  parse as b3,
  TRANSFORMABLE_PROPS as b4,
  cloneValue as b5,
  isDom as b6,
  addEventListener as b7,
  normalizeEvent as b8,
  transformLocalCoord as b9,
  hasShadow as bA,
  getShadowKey as bB,
  getSize as bC,
  encodeBase64 as bD,
  disableUserSelect as bE,
  REDRAW_BIT as bF,
  devicePixelRatio as bG,
  isGradientObject as bH,
  getCanvasGradient as bI,
  isImagePatternObject as bJ,
  createCanvasPattern as bK,
  brush as bL,
  requestAnimationFrame$1 as bM,
  logError as bN,
  isRegExp as ba,
  isAroundZero as bb,
  normalizeColor as bc,
  getLineDash as bd,
  DEFAULT_PATH_STYLE as be,
  createCubicEasingFunc as bf,
  copyTransform as bg,
  getSRTTransformString as bh,
  getPathPrecision as bi,
  isLinearGradient as bj,
  isRadialGradient as bk,
  round4 as bl,
  getIdURL as bm,
  isImagePattern as bn,
  createOrUpdateImage as bo,
  DEFAULT_FONT as bp,
  adjustTextY$1 as bq,
  getLineHeight as br,
  TEXT_ALIGN_TO_ANCHOR as bs,
  hasSeparateFont as bt,
  parseFontSize as bu,
  DEFAULT_FONT_FAMILY as bv,
  isGradient as bw,
  isPattern as bx,
  getElementSSRData as by,
  getMatrixStr as bz,
  clone$2 as c,
  curry as d,
  encodeHTML as e,
