...
}, C = { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 }, T = 1e5, M = 1e4, O = "mousemove", A = "drag", L = "content";
let z = null, R = null;
class k extends g {
  get fits() {
  ...
  constructor(t2, e2 = {}, i2 = {}) {
    ...
    this.container = t2, this.initContent(), this.attachPlugins(Object.assign(Object.assign({}, k.Plugins), i2)), this.emit("attachPlugins"), this.emit("init");
...
const Z = { Navigation: Y, Dots: $, Sync: V }, U = "animationend", G = "isSelected", K = "slide";
class J extends g {
  get axis() {
  ...
  processOptions() {
    var t2, e2;
    const i2 = u({}, J.defaults, this.userOptions);
    let n2 = "";
...
let et;
const it = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden]):not(.fancybox-focus-guard)", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'].join(","), nt = (t2) => {
  if (t2 && tt) {
...
let lt = "", ct = false, ht = false, dt = null;
const ut = () => {
  let t2 = "", e2 = "";
...
const wt = "html", xt = "image", Et = "map", St = "youtube", Pt = "vimeo", Ct = "html5video", Tt = (t2, e2 = {}) => {
...
}, Mt = { ajax: null, autoSize: true, iframeAttr: { allow: "autoplay; fullscreen", scrolling: "auto" }, preload: true, videoAutoplay: true, videoRatio: 16 / 9, videoTpl: `<video class="fancybox__html5video" playsinline controls controlsList="nodownload" poster="{{poster}}">
  <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn't support embedded videos.</video>`, videoFormat: "", vimeo: { byline: 1, color: "00adef", controls: 1, dnt: 1, muted: 0 }, youtube: { controls: 1, enablejsapi: 1, nocookie: 1, rel: 0, fs: 1 } }, Ot = ["image", "html", "ajax", "inline", "clone", "iframe", "map", "pdf", "html5video", "youtube", "vimeo"];
class At extends N {
...
const $t = Object.assign(Object.assign({}, Dt), { key: "t", showOnStart: true, parentEl: null }), Wt = "is-masked", Xt = "aria-hidden";
class qt extends N {
  constructor() {
...
class Ce extends g {
  ...
  init() {
    if (this.state === at.Destroy)
      return;
    this.state = at.Init, this.attachPlugins(Object.assign(Object.assign({}, Ce.Plugins), this.userPlugins)), this.emit("init"), this.emit("attachPlugins"), true === this.option("hideScrollbar") && (() => {
      if (!tt)
        return;
  ...
  isTopmost() {
    var t2;
    return (null === (t2 = Ce.getInstance()) || void 0 === t2 ? void 0 : t2.id) == this.id;
  }
  ...
  static bind(t2, e2, i2) {
    ...
    if (void 0 === t2 ? n2 = document.body : me(t2) ? (n2 = document.body, s2 = t2, "object" == typeof e2 && (o2 = e2 || {})) : (n2 = t2, me(e2) && (s2 = e2), "object" == typeof i2 && (o2 = i2 || {})), !n2 || !E(n2))
      return;
    s2 = s2 || "[data-fancybox]";
    const a2 = Ce.openers.get(n2) || /* @__PURE__ */ new Map();
    a2.set(s2, o2), Ce.openers.set(n2, a2), 1 === a2.size && n2.addEventListener("click", Ce.fromEvent);
  }
  static unbind(t2, e2) {
    let i2, n2 = "";
    if (me(t2) ? (i2 = document.body, n2 = t2) : (i2 = t2, me(e2) && (n2 = e2)), !i2)
      return;
    const s2 = Ce.openers.get(i2);
    s2 && n2 && s2.delete(n2), n2 && s2 || (Ce.openers.delete(i2), i2.removeEventListener("click", Ce.fromEvent));
  }
  static destroy() {
    let t2;
    for (; t2 = Ce.getInstance(); )
      t2.destroy();
    for (const t3 of Ce.openers.keys())
      t3.removeEventListener("click", Ce.fromEvent);
    Ce.openers = /* @__PURE__ */ new Map();
  }
  static fromEvent(t2) {
    if (t2.defaultPrevented)
      return;
    ...
    if (!(e2 && e2 instanceof Element))
      return;
    let n2, s2, o2, a2;
    if ([...Ce.openers].reverse().find(([t3, i3]) => !(!t3.contains(e2) || ![...i3].reverse().find(([i4, r3]) => {
    ...
    if ((!e2 || d2 || c2) && (r2 = [].slice.call(n2.querySelectorAll(s2))), e2 && !c2 && (r2 = d2 ? r2.filter((t3) => t3.getAttribute(`${h2}`) === d2) : [e2]), !r2.length)
      return;
    const p2 = Ce.getInstance();
    return p2 && p2.options.triggerEl && r2.indexOf(p2.options.triggerEl) > -1 ? void 0 : (e2 && (l2.startIndex = r2.indexOf(e2)), Ce.fromNodes(r2, l2));
  }
  static fromSelector(t2, e2, i2) {
    ...
    if (me(t2) ? (n2 = document.body, s2 = t2, "object" == typeof e2 && (o2 = e2 || {})) : t2 instanceof HTMLElement && me(e2) && (n2 = t2, s2 = e2, "object" == typeof i2 && (o2 = i2 || {})), !n2 || !s2)
      return false;
    const a2 = Ce.openers.get(n2);
    return !!a2 && (o2 = u({}, a2.get(s2) || {}, o2), !!o2 && Ce.fromNodes(Array.from(n2.querySelectorAll(s2)), o2));
  }
  ...
  static getSlide() {
    var t2;
    return (null === (t2 = Ce.getInstance()) || void 0 === t2 ? void 0 : t2.getSlide()) || null;
  }
  static show(t2 = [], e2 = {}) {
    return new Ce(t2, e2);
  }
